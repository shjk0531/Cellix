...
export function ProblemListPage() {
    ...
    useEffect(() => {
        apiClient
            .get<{ problems: ProblemSummary[]; total: number }>(
    ...
    return (
        <div style={{ minHeight: "100vh", background: "#f8f9fa" }}>
            ...
            >
                <span
                    style={{ fontSize: 18, fontWeight: 700, color: "#202124" }}
                >
                    Cellix
                </span>
                <span style={{ flex: 1 }} />
            ...
            >
                ...
                {error && (
                    <div style={{ color: "#c5221f", padding: 16 }}>{error}</div>
                )}
